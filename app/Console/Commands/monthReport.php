...
class monthReport extends Command {
     ...
     * @var string
     */
    protected $name = 'callcenter:monthReport';
     ...
     * @var string
     */
    protected $description = 'Отчет по проекту за текущий месяц';
    ...
    {
        return [
            ['project', InputArgument::REQUIRED, 'Номер проекта'],
        ];
    }
